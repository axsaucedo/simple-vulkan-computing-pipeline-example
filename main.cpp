  ...
  public:
    ...
    VulkanCompute()
    {
        ...
        // Find device (currently only pick first device)
        {
            ...
            std::cout << "INFO: " << "Device " << physicalDeviceProperties.deviceName << std::endl;
        }

        {
            std::cout << "INFO: " << "Finding compute queue" << std::endl;
            // Find compute queue
            ...
            if (this->mComputeQueueFamilyIndex < 0) {
                std::cout << "CRITICAL: " << "Compute queue is not supported" << std::endl;
            }
        ...
        */
        {
            std::cout << "INFO: " << "Copying data from host memory to staging buffer" << std::endl;
...

        {
            ...
            std::cout << "INFO: " << "Converting the read file into module" << std::endl;
            ...
            std::cout << "INFO: "<< "Converting to shader stage" << std::endl;
...

        {
            ...
            for (size_t i = 0; i < computeOutput.size(); i++) {
